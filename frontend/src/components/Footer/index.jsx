...
export default function Footer() {
  const navigation = [
    {
      name: "Email",
      href: "mailto:marcelo-mls@hotmail.com",
    ...
    },
    {
      ...
      icon: (<svg fill="currentColor" width="24px" height="24px" viewBox="0 0 24 24">
    ...
    {
      name: "GitHub",
      href: "https://github.com/marcelo-mls",
      icon: (<svg fill="currentColor" width="24px" height="24px" viewBox="0 0 24 24">
              <path
                fillRule="evenodd"
    ...
    {
      name: "WhatsApp",
      href: "https://wa.me/+5531983941991",
      icon: (<svg fill="currentColor" width="24px" height="24px" viewBox="0 0 448 512">
              <path 
              fillRule="evenodd" 
